...
- 2025/10/19 バージョン 2.0.0 リリース　商品検索機能追加
- 2025/10/24 バージョン 3.0.0 リリース　商品情報の要約機能追加
- 2025/10/29 バージョン 4.0.0 リリース　AHP計算機能追加
- 2025/10/29 バージョン 5.0.0 リリース　ランキング、グラフ表示機能追加、AHPアシスタント機能追加
